...
export class StudentsController {
  ...
  async findAll(@Query() queryDto: StudentQueryDto): Promise<PaginatedStudentResponseDto> {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Mock data seeded successfully' })
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'Unauthorized' })
