import { IsNotEmpty, IsString, IsEmail, IsDateString, IsOptional, IsBoolean, Length } from 'class-validator';
...
export class CreateStudentDto {
  ...
  @ApiProperty({ example: '2000-01-15', description: 'Date of birth (YYYY-MM-DD)' })
  @IsNotEmpty()
  @IsDateString()
  dateOfBirth: string;
  ...
  @ApiPropertyOptional({ example: '123 Main St, City, State', description: 'Address of the student' })
  @IsOptional()
  @IsString()
  address?: string;

  @ApiPropertyOptional({ example: '2024-01-15', description: 'Enrollment date (YYYY-MM-DD)' })
  @IsOptional()
  @IsDateString()
